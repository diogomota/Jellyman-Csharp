...
public class UIVerticalPanel : UIAbstractContainer
{
	...
	protected override void layoutChildren()
	{
		...
		//EDITED_-> stretch texture width to screen width /3// 
		_topStrip.setSize((Screen.width/3),_topStrip.height);
		_bottomStrip.setSize((Screen.width/3),_bottomStrip.height);
		_middleStrip.setSize( Screen.width/3, leftoverHeight );
		//END EDITED//
